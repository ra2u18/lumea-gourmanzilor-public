const gulp = require('gulp'),
      ...
      emitty = require('emitty').setup('app/src/templates', 'pug'),
...
const path = {
  src: 'app/src',
  dist: 'app/static',
  src_pug: 'app/src/templates',
  src_scss: 'app/src/scss',
  src_js: 'app/src/js',
  dist_vendor: 'app/static/vendor',
  dist_js: 'app/static/js',
  dist_css: 'app/static/css',
